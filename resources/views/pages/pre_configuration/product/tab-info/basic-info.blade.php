                ...
                @endif
                    @csrf
                        <input type="hidden" class="product_id"
                               value="@if(isset($product->id)){{$product->id}} @endif" name="product_id">
                        <table class="table table-responsive">
                            <tr>
                                ...
                                <td>
                                    <input type="text"
                                           value="{{ isset($product) ? $product->short_name : old('short_name') }}"
                                ...
                                <td>
                                    <select name="type_id" class="form-control "
                                        ...
                                        @foreach($productTypes as $productType)
                                            <option
                                                value="{{$productType->id}}" {{ isset($product) ? ($product->type_id == $productType->id ? 'selected' : '' ) : '' }}>{{$productType->name}}
                                            </option>
                                        @endforeach
                                    </select><br>
                                    @error('type_id')
                                ...
                                <td>
                                    <select name="category_id" class=" form-control  "
                                        ...
                                        @foreach($productcategories as $productcategory)
                                            <option
                                                value="{{$productcategory->id}}" {{ isset($product) ? ($product->category_id == $productcategory->id ? 'selected' : '' ) : '' }}>
                                ...
                                <td>
                                    <select name="supplier_id" class="form-control" id="supplier_id"
                                        ...
                                        @foreach($suppliers as $supplier)
                                            <option
                                                value="{{$supplier->id}}" {{ isset($product) ? ($product->supplier_id == $supplier->id ? 'selected' : '' ) : '' }}>{{$supplier->name}}
                                            </option>
                                        @endforeach
                                    </select><br>
                                    @error('supplier_id')
                            ...
                            <tr>
                                ...
                                <td><input type="text"
                                           value="{{ isset($product) ? $product->comp_seq : old('comp_seq') }}"
                                ...
                                <td><input type="text" step="any"
                                           value="{{ isset($product) ? $product->packet : old('packet') }}"
                                ...
                                <td>
                                    <select name="group_id" class="form-control" id="group_id"
                                        ...
                                        @foreach($groups as $group)
                                            <option
                                                value="{{$group->id}}" {{ isset($product) ? ($product->group_id == $group->id ? 'selected' : '' ) : '' }}>{{$group->name}}</option>
                                        @endforeach
                                        @endif
                                    </select><br>
                                    @error('group_id')
                            ...
                            <tr>
                                ...
                                <td><input type="text"
                                           value="{{ isset($product) ? $product->comp_artd_no : old('comp_artd_no') }}"
                                ...
                                <td><input type="text"
                                           value="{{ isset($product) ? $product->purchase_discount : old('purchase_discount') }}"
                                ...
                                <td><input type="text"
                                           value="{{ isset($product) ? $product->max_sale_disc : old('max_sale_disc') }}"
                            ...
                            <tr>
                                <td><label for="dd">Weight </label></td>
                                <td><input type="text"
                                ...
                                <td><input type="text"
                                           value="{{ isset($product) ? $product->sale_tax_value : old('sale_tax_value') }}"
                                ...
                                <td><input type="text"
                                           value="{{ isset($product) ? $product->inventory_day : old('inventory_day') }}"
                            ...
                            <tr>
                                ...
                                <td><input type="text"
                                           value="{{ isset($product) ? $product->purchase_rate : old('purchase_rate') }}"
                                ...
                                <td><input type="text"
                                           value="{{ isset($product) ? $product->purchase_tax_type : old('purchase_tax_type') }}"
                                ...
                                <td><input type="text"
                                           value=" {{ isset($product) ? $product->purchase_tax_value : old('purchase_tax_value') }} "
                            ...
                            <tr>
                                ...
                                <td><input type="text"
                                           value="{{ isset($product) ? $product->advance_tax_type : old('advance_tax_type') }} "
                                ...
                                <td><input type="text"
                                           value="{{ isset($product) ? $product->expire_day : old('expire_day') }} "
                                ...
                                <td><input type="text"
                                           value="{{ isset($product) ? $product->purchase_tax : old('purchase_tax') }}"
                            ...
                            <tr>
                                ...
                                <td><input type="text"
                                           value="{{ isset($product) ? $product->min_flat_rate : old('min_flat_rate') }}"
                                ...
                                <td><input type="text"
                                           value="{{ isset($product) ? $product->max_flat_rate : old('max_flat_rate') }}"
                                ...
                                <td><input type="text"
                                           value="{{ isset($product) ? $product->adv_tax_filer : old('adv_tax_filer') }}"
                            ...
                            <tr>
                                ...
                                <td><input type="text"
                                           value="{{ isset($product) ? $product->adv_tax_non_filer : old('adv_tax_non_filer') }}"
                                ...
                                <td><input type="text"
                                           value="{{ isset($product) ? $product->adv_tax_supplier : old('adv_tax_supplier') }}"
                            ...
                            <tr>
                                ...
                                <td><input type="text"
                                           value="{{ isset($product) ? $product->purchase_disc_value : old('purchase_disc_value') }}"
                                ...
                                <td><input type="text"
                                           value="{{ isset($product) ? $product->re_order_level : old('re_order_level') }}"
                                ...
                                <td><input type="text"
                                           value="{{ isset($product) ? $product->prod_shel_life_day : old('prod_shel_life_day') }}"
                            ...
                            <tr>
                                ...
                                <td><input type="text"
                                           value="{{ isset($product) ? $product->trade_price : old('trade_price') }}"
                                ...
                                <td>
                                    <input type="text"
                                           value="{{ isset($product) ? $product->group_seq : old('group_seq') }}"
                        ...
                        <div class="row">
                            <div class="d-flex justify-content-end">
                                @if(isset($product))
                                    <button type="submit" id="product_info" class="btn btn-warning me-1">
                                        Update
                                    </button>
                                @else
                                    <button type="submit" id="product_info" class="btn btn-success me-1">Save
                                    </button>
                                @endif
                                <a class="btn btn-danger mx-0" href="{{ url('products') }}">Exit</a>
                            </div>
                        </div>                                <!-- <button type="submit" id="product_info" class="btn btn-primary w-md">Submit</button> -->
                    </form>
            </div>
        </div>
    </div>
