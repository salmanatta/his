...
Route::get('storetostore', 'App\Http\Controllers\StoreController@storeToStore')->name('storeToStore');
Route::get('storetoStoreList', 'App\Http\Controllers\StoreController@storetoStoreList')->name('storetoStoreList');
