...
<div class="row">
    <div class="col-xl-12">
        <div class="card">
            <div class="card-body">
                <h4 class="card-title mb-4">Customer Personal Info </h4>
                <hr>
                <form class="" method="post" action="{{route('customers.store')}}" enctype="multipart/form-data">
                    ...
                    <div class="row">
                        <h4 class="card-title mb-4">Office Info</h4>
                        <hr>
                    ...
                    <div class="row">
                        <h4 class="card-title mb-4">License Reg</h4>
                        <hr>
                            ...
                            <table class="table table-bordered " id="license_table">
                                <tr>
                                    ...
                                    <td><label for="formrow-inputState" class="form-label">License Name</label>
                                        ...
                                        <input type="text" placeholder="license Name" id="license_name" width="8%" name="license_name[]" class="form-control license_name" />
                                    </td>
                                    ...
                                    <td>
                                        <div style="padding-top: 29px;"></div><button type="button" name="add_to" id="add_to" class="btn btn-success btn-sm add_to">+</button>
                                    </td>
                                </tr>
                            </table>
                        </div>
                    ...
                    <div class="row">
                        <h4 class="card-title mb-4">Tax Reg</h4>
                        <hr>
                        <div class="table-responsive">
                            <table class="table table-bordered " id="item_table">
                                <tr>
                                    <td>
                                        <input type="hidden" name="raw_row[]" value="0" id="raw_row">
                                        <label for="formrow-inputState" class="form-label">CNIC No</label>
                                        <input type="text" placeholder="CNIC No" id="cnic" width="8%" name="cnic[]" class="form-control cnic" />
                                    </td>
                                    <td>
                                        <label for="formrow-inputState" class="form-label">NTN No</label>
                                        <input type="number" placeholder="NTN No" id="ntn" width="8%" name="ntn[]" class="form-control ntn" />
                                    </td>
                                    <td>
                                        <label for="formrow-inputState" class="form-label">STRN No</label>
                                        <input type="number" placeholder="STRN No" id="ntn" width="8%" name="sntn[]" class="form-control  sntn" />
                                    </td>
                                    <td>
                                        <label for="formrow-inputState" class="form-label">Exemption</label>
                                        <input type="number" placeholder="exemption" id="exemption" width="8%" name="exemption[]" class="form-control  exemption" />
                                    </td>
                                    <td>
                                        <label for="formrow-inputState" class="form-label">Upload Certificate</label>
                                    ...
                                    <td>
                                        <div style="padding-top: 29px;"></div><button type="button" name="add" id="add" class="btn btn-success btn-sm add">+</button>
                                    </td>
                                </tr>
                            </table>
                        </div>
