            ...
            <div class="modal-body">
                <form action="{{route('product_bonuses.store')}}" id="bonusFormId" method="POST">
                    ...
                    <div class="text-sm-end ">
                        <a type="button" class="btn btn-primary btn waves-effect waves-light mb-2 me-2 mr-3 bonus_add" data-bs-dismiss="modal"> Add</a>
                    </div>
                </form>
                <br><br>                
            </div>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="" id="discountFormId" method="POST">
                    ...
                    <br><br>
                    <div class="text-sm-end ">
                        <a type="button" class="btn btn-primary btn waves-effect waves-light mb-2 me-2 mr-3 discount_add"> Add</a>
                    </div>
                </form>
                <br> <br>
            </div>
    ...
    <div class="col-6">
        <div class="card">
            <div class="card-body">
                ...
                <div class="col-sm-12">
                    <div class="text-sm-end">
                        <a type="button" class="btn btn-primary btn waves-effect waves-light mb-2 me-2" data-bs-toggle="modal" data-bs-target=".bonus">
                            <i class="mdi mdi-plus me-1"></i> Add</a>
                    </div>
                </div><!-- end col-->
                <div class="dataTables_wrapper dt-bootstrap4 no-footer">
                    <table class="table align-middle table-nowrap table-hover no-footer" id="datatable-buttons" role="grid" aria-describedby="datatable-buttons_info">
                ...
                <!-- <table id="datatable-buttons_wrapper" class="table align-middle table-nowrap table-hover w-100"> -->
            </div>
        </div>
    </div>
    <div class="col-6">
        <div class="card">
            <div class="card-body">
                ...
                <div class="col-sm-12">
                    <div class="text-sm-end">
                        <a type="button" class="btn btn-primary btn waves-effect waves-light mb-2 me-2" data-bs-toggle="modal" data-bs-target=".discount">
                            <i class="mdi mdi-plus me-1"></i> Add</a>
                    </div>
                </div><!-- end col-->
                <div class="dataTables_wrapper dt-bootstrap4 no-footer">
                    <table class="table align-middle table-nowrap table-hover dataTable no-footer" id="datatable-buttons" role="grid" aria-describedby="datatable-buttons_info">
                        <thead class="table-light">
                            <tr>
                                <th class="align-middle"> #</th>
                        ...
                        <tbody id="append_here2">
                            ...
                            <tr data-id="{{$value->id}}">
                                <td>
                                    <a href="javascript: void(0);" class="text-body fw-bold">{{$loop->iteration}}</a> 
                                </td>
