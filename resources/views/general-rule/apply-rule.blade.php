        ...
        <div class="col-xl-4">
            <div class="row">
                <div class="col-xl-12">
                    <div class="card">
                        <div class="card-body">
                            <h4 class="card-title mb-4">Apply Bonus & Discount on Product</h4>
                            <hr>
                            <form class="" method="post" id="addFormId" action="#" enctype="multipart/form-data">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <select id="bonus_id" name="bonus_id" class="form-select select2 bonus_id">
                                                ...
                                                @foreach($bonuses as $Bonus)
                                                    <option value="{{$Bonus->id}}" data-bonus="{{$Bonus->bonus}}"
                                                            data-b_start_date="{{$Bonus->start_date}}"
                                                            data-b_end_date="{{$Bonus->end_date}}"
                                                            data-quantity="{{$Bonus->quantity}}">Bonus -> {{$Bonus->bonus}} |
                                                        Quantity -> {{$Bonus->quantity}} | From: {{$Bonus->start_date}}
                                                        To: {{$Bonus->end_date}}</option>
                                                @endforeach
                                            </select>
                                        </div>
                                    </div>
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <select id="discount_id" name="discount_id"
                                                ...
                                                @foreach($discounts as $value)
                                                    <option value="{{$value->id}}" data-discount="{{$value->discount}}"
                                                            data-d_start_date="{{$value->start_date}}"
                                                            data-d_end_date="{{$value->end_date}}">Discount
                                                        -> {{$value->discount}}% | From: {{$value->start_date}}
                                                        To: {{$value->end_date}}</option>
                                                @endforeach
                                            </select>
                                        </div>
                                    </div>
                                ...
                                <div class="d-flex justify-content-end">
                                        <button type="submit" class="btn btn-success me-1 sub_add">Save</button>
