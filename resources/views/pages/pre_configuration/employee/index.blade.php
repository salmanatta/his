                ...
                <div class="card-body">
                    ...
                    <div class="col-sm-12">
                            <div class="text-sm-end">
                                 <a type="button"
                                    class="btn btn-primary waves-effect waves-light mb-2 me-2" href="{{route('employees.create')}}"><i
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <a href="#" class="btn btn-primary btn-sm detail_view_button" data-bs-toggle="modal" data-bs-target=".bs-example-modal-lg" 
                                            data-employee_id="{{$employee->id}}" data-employee_name="{{$employee->first_name.' '.$employee->middle_name.' '.$employee->last_name}}"
                                            data-phone_off="{{$employee->phone_off}}" data-fax="{{$employee->fax}}" data-email="{{$employee->email}}" 
                                            >
                                            View Details
                                        </a>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <table cellpadding="5" cellmargin="5">
                        <tr> <th> Employee ID </th><td> : <span class="m_employee_id"> </span>   </td></tr>
                        <tr> <th> Employee Name </th><td> : <span class="m_employee_name"> </span>     </td>  </tr>
                        <tr> <th> Contact </th><td> : <span class="m_phone_off"> </span>   </td></tr>
                        <tr> <th> Fax </th><td> : <span class="m_fax"> </span>   </td></tr>
                        <tr> <th> Email </th><td> : <span class="m_email"> </span>   </td></tr>
