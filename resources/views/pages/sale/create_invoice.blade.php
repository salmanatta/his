                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <span>
                                                            ...
                                                            <div class="col-12 mb-3">
                                                                ...
                                                                <input type="text" class="form-control" name="salesman_name" value="{{ $booking->salesman->first_name.' '.$booking->salesman->last_name }}" readonly>
                                                                <input type="hidden" class="form-control" name="salesman_id" value="{{ $booking->salesman->id }}" readonly>
                                                            </div>
                                                            <div class="col-12 mb-3">
                                                                <label class="form-label"
                                                        ...
                                                        <div class="col-4">
                                                            ...
                                                            <div class="col-12 mb-3">
                                                                ...
                                                                <textarea placeholder="description" name="description"
                                                                          rows="1"
                                                                          class="form-control _description"></textarea>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
