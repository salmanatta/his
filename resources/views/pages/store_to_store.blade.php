            ...
            <div class="col-4">
              ...
              <div class="col-md-12">
                <div class="mb-3 ">
                  ...
                  <textarea type="text" cols="4" rows="4" name="description" class="form-control" id="validationCustom01" required></textarea>
                </div>
              </div>
            </div>
          </div>
    ...
    $.ajax({
      ...
      success: function(data) {
        ...
        var new_row = `<tr class="table_append_rows" id="table_append_rows_` + row_id + `">
             ...
             <input type="number" class="form-control" name="total_price[]" value="` + data.price * data.quantity + `" step="any"/>
             </td> 
