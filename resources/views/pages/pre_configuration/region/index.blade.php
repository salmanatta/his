                ...
                <div class="card-body">
                        ...
                        <div class="text-sm-end">
                            <a type="button"
                               ...
                               href="{{route('regions.create')}}">
                                <i class="mdi mdi-plus me-1"></i> Add Region
                            </a>
                        </div>
                    </div><!-- end col-->
                    <table id="datatable-buttons" class="table table-bordered dt-responsive nowrap w-100">
                        ...
                        <tr>
                            ...
                            <th class="text-center" width="5%">Region ID</th>
                            <th class="align-middle" width="35%">Region Name</th>
                            <th class="align-middle" width="35%">Parent Region</th>
                            <th class="align-middle" width="15%">City</th>
