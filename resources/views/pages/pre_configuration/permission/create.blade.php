...
<div class="row">
    <div class="col-xl-12">
        <div class="card">
            <div class="card-body">
                <h4 class="card-title mb-4">Permission Form </h4>
                ...
                <form class="" method="post" action="{{route('permissions.store')}}">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-4">
                            <div class="mb-3">
                                <input type="hidden" value="{{$permission->company_id ?? ''}}" class="hidden_company_id">
                                <input type="hidden" name="hidden_id" value="{{$permission->id ?? ''}}" class="hidden_id">
                        ...
                        <div class="col-lg-4">
                            <div class="mb-3">
                                ...
                                <input type="text" value="{{$permission->name ?? ''}}" name="name" class="form-control" id="" required>
                        ...
                        <div class="col-lg-4">
                            <div class="mb-3">
                                ...
                                <input type="text" value="{{$permission->display_name ?? ''}}" name="display_name" class="form-control" id="" required>
                        ...
                        <div class="col-lg-12">
                            <div class="mb-3">
                                ...
                                <textarea style="resize: none" type="text" name="description" class="form-control" id="" required>{{$permission->description ?? ''}}</textarea>
                            </div>
                        </div>
