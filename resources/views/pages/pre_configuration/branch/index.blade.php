                   ...
                   <h4 class="card-title">branch Details</h4>
                    <div class="col-sm-12">
                            <div class="text-sm-end">
                                 <a type="button"
                                    class="btn btn-primary btn waves-effect waves-light mb-2 me-2" href="{{route('branches.create')}}"><i
                                        class="mdi mdi-plus me-1"></i> Add branch</a>
                            </div>
                        </div><!-- end col-->
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <table cellpadding="5" cellmargin="5">
                        <tr> <th> Branch ID </th><td> : <span class="m_branch_id"> </span>   </td></tr>
