...
success:function(data){
             ...
             $.each(data, function(l, val)
    {
     ...
     html+=`<tr><td >`+product_count+`</td><td >`+val.invoice_no+`</td><td >`+val.date+`</td><td >`+val.user.name+`</td><td >`+val.customer.name+`</td><td >`+val.branch.name+`</td><td >`+val.sub_total+`</td><td ><a href="${rt}"  style="border-radius: 44px;" class="btn btn-primary btn-sm btn-rounded waves-effect waves-light d-print-none">
